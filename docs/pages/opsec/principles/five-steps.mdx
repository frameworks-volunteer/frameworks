...
> informs [Data Protection](/opsec/control-domains/technical/encrypted-storage-backups) strategies.
...
> Vectors](/awareness/understanding-threat-vectors) and [Threat Modeling](/opsec/principles/five-steps) frameworks.
